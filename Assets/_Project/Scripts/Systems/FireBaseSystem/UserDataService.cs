...
public class UserDataService
{
    ...
    public void GetUserData(Action<UserData> callback)
    {
        ...
        {
            Debug.LogError("Cannot get user data: " + (User == null ? "User is null" : "Database reference is null"));
    ...
    public void SaveUserToDatabase()
    {
        if (User == null || databaseRef == null)
        {
            Debug.LogError("Cannot save user data: " + (User == null ? "User is null" : "Database reference is null"));
            return;
        }
